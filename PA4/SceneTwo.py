...
class SceneTwo(Component, Animation):
    ...
    def __init__(self, shaderProg):
        ...
        torus = Component(Point((1, 1, 0)), DisplayableTorus(shaderProg, 0.25, 0.5, 36, 36))
        ...
        ellipsoid = Component(Point((1, -1, 0)), DisplayableEllipsoid(shaderProg, 0.5, 0.5, 0.8, 36, 36))
